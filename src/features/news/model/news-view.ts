...
> = {
  ...
  "sintered-stone-vs-quartz-vs-marble": [
    {
      src: "/assets/solutions/quartz-zero-silica.jpg",
      alt: {
        en: "Quartz and silica-free surface sample display",
        zh: "石英石与零硅表面样板展示",
        es: "Muestras de cuarzo y superficies sin sílice",
        ar: "عرض عينات كوارتز وأسطح خالية من السيليكا",
      },
      caption: {
        en: "Quartz remains practical, but silica exposure has become part of the material decision.",
        zh: "石英石仍然实用，但硅尘暴露已经成了选材时绕不开的一项。",
        es: "El cuarzo sigue siendo práctico, pero la exposición al sílice ya forma parte de la decisión.",
        ar: "يبقى الكوارتز عمليا، لكن التعرض للسيليكا أصبح جزءا من قرار اختيار المادة.",
      },
    },
    {
      src: "/assets/solutions/marble.jpg",
      alt: {
        en: "Natural marble surface texture",
        zh: "天然大理石纹理表面",
        es: "Textura de mármol natural",
        ar: "ملمس سطح رخام طبيعي",
      },
      caption: {
        en: "Natural marble still wins on depth and variation, but it asks for upkeep.",
        zh: "天然大理石的纹理深度还是强，但维护成本也真实存在。",
        es: "El mármol natural conserva profundidad y variación, aunque exige mantenimiento.",
        ar: "يحافظ الرخام الطبيعي على العمق والتنوع، لكنه يحتاج إلى صيانة.",
      },
    },
  ],
