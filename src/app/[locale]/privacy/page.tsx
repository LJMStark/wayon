...
const COPY: Record<AppLocale, PrivacyCopy> = {
  zh: {
    ...
    sections: [
      ...
      {
        heading: "第三方服务",
        body: "询价邮件通过 Resend 送达公司邮箱；网站内容存储于自托管 Payload CMS（数据库由 Zeabur 托管，媒体文件存储于 Cloudflare R2）；基础设施由 Zeabur 提供。上述服务商仅在为本站提供服务所必需的范围内处理数据。",
      },
      {
        heading: "您的权利",
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Inquiry emails are delivered via Resend; website content is stored in a self-hosted Payload CMS (database on Zeabur, media files on Cloudflare R2); infrastructure is hosted on Zeabur. These providers process data strictly as needed to operate the site.",
      },
      {
        heading: "Your Rights",
  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Los correos de consulta se entregan vía Resend; el contenido se almacena en un Payload CMS autoalojado (base de datos en Zeabur, archivos multimedia en Cloudflare R2); la infraestructura se aloja en Zeabur. Estos proveedores procesan datos estrictamente en la medida necesaria para operar el sitio.",
      },
      {
  ...
  ar: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "تُرسل رسائل الاستفسار عبر Resend؛ ويُخزَّن المحتوى في نظام Payload CMS ذاتي الاستضافة (قاعدة البيانات على Zeabur، وملفات الوسائط على Cloudflare R2)؛ والبنية التحتية مُستضافة على Zeabur. يعالج هؤلاء المزودون البيانات فقط بالقدر اللازم لتشغيل الموقع.",
      },
      {
        heading: "حقوقك",
