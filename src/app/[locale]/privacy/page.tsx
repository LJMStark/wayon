...
const COPY: Record<AppLocale, PrivacyCopy> = {
  ...
  ru: {
    ...
    intro:
      "Компания Guangdong ZYL Sintered Stone Technology Co., Ltd. (\u201Cмы\u201D) управляет сайтом zylsinteredstone.com. Эта политика описывает, как мы собираем, используем и защищаем вашу информацию при посещении сайта или обращении к нам через него.",
    sections: [
      {
        heading: "Какую информацию мы собираем",
        body: "Когда вы отправляете запрос, подписываетесь или связываетесь с нами по электронной почте или WhatsApp, мы собираем предоставленные вами данные: имя, e-mail, телефон или WhatsApp, название компании, страну или регион, интересующую продукцию и описание проекта. Журналы сервера автоматически фиксируют технические данные: IP, браузер, путь навигации — для задач безопасности и анализа производительности.",
      },
      {
        heading: "Как мы используем информацию",
        body: "Мы используем ваши данные только для ответа на запросы, отправки образцов и коммерческих предложений, последующего делового общения, исполнения обязательств по хранению документов, а также улучшения содержания и производительности сайта. Мы не продаём вашу персональную информацию третьим лицам.",
      },
      {
        heading: "Cookie и аналитика",
        body: "По умолчанию сайт не устанавливает рекламные или межсайтовые трекинговые cookie. Мы используем аналитику, совместимую с Google Consent Mode v2: без вашего согласия аналитические cookie не записываются и персональные данные не передаются.",
      },
      {
      ...
      {
        heading: "Ваши права",
        body: "Вы можете в любой момент запросить доступ, исправление или удаление ваших персональных данных, а также отозвать ранее данное согласие на подписку или обращение. Мы ответим в разумный срок.",
      },
      {
        heading: "Сроки хранения и трансграничная передача",
        body: "Запросы клиентов обычно хранятся 24 месяца для задач послепродажного обслуживания и коммерческого сопровождения. Так как мы работаем с клиентами по всему миру, ваши данные могут передаваться или храниться на серверах за пределами материкового Китая.",
      },
    ],
    contactHeading: "Контакты",
    contactBody:
      "По любым вопросам о данной Политике конфиденциальности пишите на zyl.stone.slab@gmail.com или WhatsApp +86 132 2924 6894.",
  },
};
