...
const COPY: Record<AppLocale, TermsCopy> = {
  ...
  ru: {
    ...
    updated: "Последнее обновление: 19 апреля 2026 г.",
    intro:
      "Настоящие Условия регулируют доступ к сайту zylsinteredstone.com (оператор — Guangdong ZYL Sintered Stone Technology Co., Ltd.) и его использование, а также последующие деловые коммуникации. Продолжая пользоваться сайтом, вы соглашаетесь с этими Условиями.",
    sections: [
      {
        heading: "Контент и интеллектуальная собственность",
        body: "Тексты, изображения, видео, каталоги продукции, логотипы и макеты сайта принадлежат нам или нашим партнёрам. Запрещается копировать, переопубликовывать, зеркалировать или использовать их в коммерческих целях без предварительного письменного согласия. Спецификации, цвета, фактуры и параметры приведены ориентировочно; приоритет имеют физический образец и подписанный договор.",
      },
      {
        heading: "Запросы и коммерческие предложения",
        body: "Запросы, отправленные через сайт, представляют собой выражение интереса и не являются офертой или договором. Итоговые характеристики, цены, сроки и условия оплаты фиксируются в подписанных PI или договоре купли-продажи. Чертежи, макеты и образцы остаются в нашем распоряжении до подписания договора.",
      },
      {
        heading: "Допустимое использование",
        body: "Нельзя использовать сайт для незаконной деятельности, спама, загрузки вредоносного кода, несанкционированного парсинга или обхода мер безопасности. Мы оставляем за собой право ограничивать доступ при выявлении нарушений.",
      },
      {
        heading: "Отказ от ответственности",
        body: "Информация на сайте предоставляется \u201Cкак есть\u201D. Мы прилагаем разумные усилия для её точности, но не гарантируем отсутствие ошибок и непрерывной доступности. Мы не несём ответственности за косвенные убытки, связанные с использованием сайта.",
      },
      {
        heading: "Ссылки и третьи стороны",
        body: "Сайт может содержать ссылки или встроенные сервисы третьих сторон (Instagram, YouTube, Pinterest, Google Maps и др.). Эти ресурсы управляются их владельцами, и мы не отвечаем за их контент и практики конфиденциальности.",
      },
      {
        heading: "Применимое право",
        body: "Настоящие Условия регулируются законодательством Китайской Народной Республики. Споры решаются прежде всего путём добросовестных переговоров; при недостижении согласия передаются в компетентный суд по месту регистрации компании.",
      },
      {
        heading: "Обновления",
        body: "Мы можем периодически обновлять эти Условия в связи с изменениями в бизнесе или требованиях соответствия. Обновления вступают в силу с момента публикации; продолжение использования сайта означает принятие обновлённых Условий.",
      },
    ],
    contactHeading: "Контакты",
    contactBody:
      "По любым вопросам к настоящим Условиям пишите на zyl.stone.slab@gmail.com или WhatsApp +86 132 2924 6894.",
  },
};
