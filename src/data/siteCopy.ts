...
const SITE_COPY = {
  ...
  aboutPage: {
    ...
    philosophyDescription: {
      ...
      ru: "Миссия: обеспечить пользователям лучшую жизнь с помощью быстрых и надёжных услуг по производству обожжённого камня. Видение: стать ведущей мировой брендированной платформой услуг из обожжённого камня. Ценности: Пользователи прежде всего · Ориентация на сервис · Альтруизм и взаимовыгодное сотрудничество.",
    },
    philosophyTabs: {
    ...
    philosophyMission: {
      ...
      ru: "Обеспечить пользователям лучшую жизнь с помощью быстрых и надёжных услуг по производству обожжённого камня.",
    },
    philosophyVision: {
      ...
      ru: "Стать ведущей мировой брендированной платформой услуг из обожжённого камня.",
    },
    philosophyValues: {
      ...
      ru: "Пользователи прежде всего · Ориентация на сервис · Альтруизм и взаимовыгодное сотрудничество",
    },
    certificatesTitle: {
      en: "Certificates",
      zh: "资质证书",
    ...
    developmentHistory: [
      ...
      },
      {
        ...
        text: {
          ...
          ru: "Две современные производственные базы, оснащённые итальянским прессом SACMI мощностью 38 000 тонн, итальянской цифровой печатью SITI 6D, полностью автоматизированной широкоформатной прецизионной печью и высокоточной линией шлифовки и полировки KEDA, обеспечивают годовую мощность около 160 000 000 кв. м.",
        },
      },
    ],
    moreButton: {
  ...
  contactPage: {
    ...
    mapTitle: {
      ...
      ru: "Карта офиса и шоурума в Фошане",
    },
    mapSubtitle: {
      ...
      ru: "Контактная информация офиса, шоурума и фабрики",
    },
    mapEmbedUrl:
